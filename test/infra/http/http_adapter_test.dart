...
void main() {
  ...
  group('put', () {
    ...
    test('should return null data if put returns 200 with no data', () async {
      mockResponse(200, body: '');
    ...
    test('should return InternalServerError if put returns 500', () async {
      mockResponse(500);
    ...
    test('should return InternalServerError if put throws', () async {
      mockError();
